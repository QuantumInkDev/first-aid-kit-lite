  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between bg-gray-50">
        <h3 className="text-sm font-semibold text-gray-900">Tool Runs</h3>
      ...
      <div className="overflow-y-auto flex-1">
        ...
        {activeExecutions.length === 0 && recentExecutions.length === 0 && (
          <div className="p-8 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No tool runs</h3>
            <p className="mt-1 text-sm text-gray-500">
              Tool runs will appear here when you run them
            </p>
          </div>
        )}
      </div>
